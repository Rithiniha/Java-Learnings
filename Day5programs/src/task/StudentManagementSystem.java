...
class Student_Management_system {
    ...
    void addStudent(int id, String name, double grade) {
        ...
        // Write the players details to a file
        try (FileWriter fw = new FileWriter("students.txt", true); BufferedWriter bw = new BufferedWriter(fw)) {
            bw.write("ID: " + id + ", Name: " + name + ", Grade: " + grade + "\n");
